...
using M = Domain.Chessboard.GameStates.Move;

namespace DomainTests.Chessboard.GameStates;

public class ClassicGameStateTests
{
    public static IEnumerable<IEnumerable<M>> BlackMovesAfterWhiteTestCases
    {
        get
        {
            ...
            yield return
            [
                new M(new Man("1", Color.White), P.A1, P.B2), new M(new Man("2", Color.Black), P.B8, P.A7),
                new M(new Man("3", Color.White), P.A3, P.D4)
            ];
            yield return
            [
                new M(new Man("1", Color.White), P.A1, P.B2), new M(new King("2", Color.Black), P.B8, P.A7),
                new M(new Man("3", Color.White), P.A3, P.D4)
            ];
            yield return
            [
                new M(new Man("1", Color.White), P.A1, P.B2), new M(new King("2", Color.Black), P.B8, P.A7),
                new M(new King("3", Color.White), P.A3, P.D4)
            ];
            yield return
            [
                new M(new Man("1", Color.White), P.A1, P.B2), new M(new Man("2", Color.Black), P.B8, P.A7),
            ...
            yield return
            [
                new M(new King("1", Color.White), P.A1, P.B2), new M(new Man("2", Color.Black), P.B8, P.A7),
                new M(new Man("3", Color.White), P.A3, P.D4)
            ];
            yield return
            [
                new M(new King("1", Color.White), P.A1, P.B2), new M(new King("2", Color.Black), P.B8, P.A7),
                new M(new Man("3", Color.White), P.A3, P.D4)
            ];
            yield return
            [
    ...
    public static IEnumerable<IEnumerable<M>> WhiteMovesAfterBlackTestCases
    {
        get
        {
