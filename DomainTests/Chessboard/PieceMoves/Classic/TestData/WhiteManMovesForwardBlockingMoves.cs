...
public class WhiteManMovesForwardBlockingMoves : IEnumerable
{
    public IEnumerator GetEnumerator()
    {
        ...
        {
            SourcePiece = P.A1, BlockingPieces = new List<P>(), // No blocking pieces for A1 on the first move
        ...
        yield return new BlockedMoveForwardTestCase
        {
            SourcePiece = P.C1, BlockingPieces = new List<P> {P.B2},
        ...
        yield return new BlockedMoveForwardTestCase
        {
            SourcePiece = P.C1, BlockingPieces = new List<P> {P.D2},
            Moves = new List<PossibleMove> {new(P.B2, new List<P> {P.B2}, 0)}
        };
        ...
        yield return new BlockedMoveForwardTestCase
        {
            SourcePiece = P.E1, BlockingPieces = new List<P> {P.D2},
            Moves = new List<PossibleMove> {new(P.F2, new List<P> {P.F2}, 0)}
        };
        // Blocked by F2, move to D2
        yield return new BlockedMoveForwardTestCase
        {
            SourcePiece = P.E1, BlockingPieces = new List<P> {P.F2},
            Moves = new List<PossibleMove> {new(P.D2, new List<P> {P.D2}, 0)}
        };
        ...
        yield return new BlockedMoveForwardTestCase
        {
            SourcePiece = P.G1, BlockingPieces = new List<P> {P.F2},
            Moves = new List<PossibleMove> {new(P.H2, new List<P> {P.H2}, 0)}
        };
        // Blocked by H2, move to F2
        yield return new BlockedMoveForwardTestCase
        {
            SourcePiece = P.G1, BlockingPieces = new List<P> {P.H2},
            Moves = new List<PossibleMove> {new(P.F2, new List<P> {P.F2}, 0)}
        };
        ...
        yield return new BlockedMoveForwardTestCase
        {
            SourcePiece = P.C1, BlockingPieces = new List<P> {P.B2, P.D2},
        ...
        yield return new BlockedMoveForwardTestCase
        {
            SourcePiece = P.E1, BlockingPieces = new List<P> {P.D2, P.F2},
            Moves = Enumerable.Empty<PossibleMove>()
        };
        ...
        yield return new BlockedMoveForwardTestCase
        {
            SourcePiece = P.G1, BlockingPieces = new List<P> {P.F2, P.H2},
            Moves = Enumerable.Empty<PossibleMove>()
        };
        ...
        yield return new BlockedMoveForwardTestCase
        {
            SourcePiece = P.B2, BlockingPieces = new List<P> {P.A3},
        ...
        yield return new BlockedMoveForwardTestCase
        {
            SourcePiece = P.B2, BlockingPieces = new List<P> {P.C3},
        ...
        yield return new BlockedMoveForwardTestCase
        {
            SourcePiece = P.D2, BlockingPieces = new List<P> {P.C3},
        ...
        yield return new BlockedMoveForwardTestCase
        {
            SourcePiece = P.D2, BlockingPieces = new List<P> {P.E3},
            Moves = new List<PossibleMove> {new(P.C3, new List<P> {P.C3}, 0)}
        };
        ...
        yield return new BlockedMoveForwardTestCase
        {
            SourcePiece = P.F2, BlockingPieces = new List<P> {P.E3},
        ...
        yield return new BlockedMoveForwardTestCase
        {
            SourcePiece = P.F2, BlockingPieces = new List<P> {P.G3},
            Moves = new List<PossibleMove> {new(P.E3, new List<P> {P.E3}, 0)}
        };
        ...
        yield return new BlockedMoveForwardTestCase
        {
            SourcePiece = P.B2, BlockingPieces = new List<P> {P.A3, P.C3},
            Moves = Enumerable.Empty<PossibleMove>()
        };
        ...
        yield return new BlockedMoveForwardTestCase
        {
            SourcePiece = P.D2, BlockingPieces = new List<P> {P.C3, P.E3},
            Moves = Enumerable.Empty<PossibleMove>()
        };
        ...
        yield return new BlockedMoveForwardTestCase
        {
            SourcePiece = P.F2, BlockingPieces = new List<P> {P.E3, P.G3},
            Moves = Enumerable.Empty<PossibleMove>()
        };
        ...
        yield return new BlockedMoveForwardTestCase
        {
            SourcePiece = P.C3, BlockingPieces = new List<P> {P.B4},
        ...
        yield return new BlockedMoveForwardTestCase
        {
            SourcePiece = P.C3, BlockingPieces = new List<P> {P.D4},
        ...
        yield return new BlockedMoveForwardTestCase
        {
            SourcePiece = P.E3, BlockingPieces = new List<P> {P.D4},
        ...
        yield return new BlockedMoveForwardTestCase
        {
            SourcePiece = P.E3, BlockingPieces = new List<P> {P.F4},
            Moves = new List<PossibleMove> {new(P.D4, new List<P> {P.D4}, 0)}
        };
        ...
        yield return new BlockedMoveForwardTestCase
        {
            SourcePiece = P.G3, BlockingPieces = new List<P> {P.F4},
        ...
        yield return new BlockedMoveForwardTestCase
        {
            SourcePiece = P.G3, BlockingPieces = new List<P> {P.H4},
            Moves = new List<PossibleMove> {new(P.F4, new List<P> {P.F4}, 0)}
        };
        ...
        yield return new BlockedMoveForwardTestCase
        {
            SourcePiece = P.A3, BlockingPieces = new List<P> {P.B4}, // Only one blocker since it's an edge
            Moves = Enumerable.Empty<PossibleMove>()
        };
        ...
        yield return new BlockedMoveForwardTestCase
        {
            SourcePiece = P.C3, BlockingPieces = new List<P> {P.B4, P.D4},
            Moves = Enumerable.Empty<PossibleMove>()
        };
        ...
        yield return new BlockedMoveForwardTestCase
        {
            SourcePiece = P.E3, BlockingPieces = new List<P> {P.D4, P.F4},
            Moves = Enumerable.Empty<PossibleMove>()
        };
        ...
        yield return new BlockedMoveForwardTestCase
        {
            SourcePiece = P.G3, BlockingPieces = new List<P> {P.F4, P.H4},
            Moves = Enumerable.Empty<PossibleMove>()
        };
        ...
        yield return new BlockedMoveForwardTestCase
        {
            SourcePiece = P.B4, BlockingPieces = new List<P> {P.A5, P.C5},
            Moves = Enumerable.Empty<PossibleMove>()
        };
        ...
        yield return new BlockedMoveForwardTestCase
        {
            SourcePiece = P.D4, BlockingPieces = new List<P> {P.C5, P.E5},
            Moves = Enumerable.Empty<PossibleMove>()
        };
        ...
        yield return new BlockedMoveForwardTestCase
        {
            SourcePiece = P.F4, BlockingPieces = new List<P> {P.E5, P.G5},
            Moves = Enumerable.Empty<PossibleMove>()
        };
        ...
        yield return new BlockedMoveForwardTestCase
        {
            SourcePiece = P.H4, BlockingPieces = new List<P> {P.G5},
            Moves = Enumerable.Empty<PossibleMove>()
        };
        ...
        yield return new BlockedMoveForwardTestCase
        {
            SourcePiece = P.B4, BlockingPieces = new List<P> {P.A5},
        ...
        yield return new BlockedMoveForwardTestCase
        {
            SourcePiece = P.B4, BlockingPieces = new List<P> {P.C5},
        ...
        yield return new BlockedMoveForwardTestCase
        {
            SourcePiece = P.D4, BlockingPieces = new List<P> {P.C5},
        ...
        yield return new BlockedMoveForwardTestCase
        {
            SourcePiece = P.D4, BlockingPieces = new List<P> {P.E5},
            Moves = new List<PossibleMove> {new(P.C5, new List<P> {P.C5}, 0)}
        };
        ...
        yield return new BlockedMoveForwardTestCase
        {
            SourcePiece = P.F4, BlockingPieces = new List<P> {P.E5},
        ...
        yield return new BlockedMoveForwardTestCase
        {
            SourcePiece = P.F4, BlockingPieces = new List<P> {P.G5},
            Moves = new List<PossibleMove> {new(P.E5, new List<P> {P.E5}, 0)}
        };
        ...
        yield return new BlockedMoveForwardTestCase
        {
            SourcePiece = P.A5, BlockingPieces = new List<P> {P.B6}, // A5 can only move to B6
            Moves = Enumerable.Empty<PossibleMove>()
        };
        ...
        yield return new BlockedMoveForwardTestCase
        {
            SourcePiece = P.C5, BlockingPieces = new List<P> {P.B6, P.D6},
            Moves = Enumerable.Empty<PossibleMove>()
        };
        ...
        yield return new BlockedMoveForwardTestCase
        {
            SourcePiece = P.E5, BlockingPieces = new List<P> {P.D6, P.F6},
            Moves = Enumerable.Empty<PossibleMove>()
        };
        ...
        yield return new BlockedMoveForwardTestCase
        {
            SourcePiece = P.G5, BlockingPieces = new List<P> {P.F6, P.H6},
            Moves = Enumerable.Empty<PossibleMove>()
        };
        ...
        yield return new BlockedMoveForwardTestCase
        {
            SourcePiece = P.C5, BlockingPieces = new List<P> {P.B6},
        ...
        yield return new BlockedMoveForwardTestCase
        {
            SourcePiece = P.C5, BlockingPieces = new List<P> {P.D6},
        ...
        yield return new BlockedMoveForwardTestCase
        {
            SourcePiece = P.E5, BlockingPieces = new List<P> {P.D6},
        ...
        yield return new BlockedMoveForwardTestCase
        {
            SourcePiece = P.E5, BlockingPieces = new List<P> {P.F6},
            Moves = new List<PossibleMove> {new(P.D6, new List<P> {P.D6}, 0)}
        };
        ...
        yield return new BlockedMoveForwardTestCase
        {
            SourcePiece = P.G5, BlockingPieces = new List<P> {P.F6},
        ...
        yield return new BlockedMoveForwardTestCase
        {
            SourcePiece = P.G5, BlockingPieces = new List<P> {P.H6},
            Moves = new List<PossibleMove> {new(P.F6, new List<P> {P.F6}, 0)}
        };
        ...
        yield return new BlockedMoveForwardTestCase
        {
            SourcePiece = P.B6, BlockingPieces = new List<P> {P.A7, P.C7},
            Moves = Enumerable.Empty<PossibleMove>()
        };
        ...
        yield return new BlockedMoveForwardTestCase
        {
            SourcePiece = P.D6, BlockingPieces = new List<P> {P.C7, P.E7},
            Moves = Enumerable.Empty<PossibleMove>()
        };
        ...
        yield return new BlockedMoveForwardTestCase
        {
            SourcePiece = P.F6, BlockingPieces = new List<P> {P.E7, P.G7},
            Moves = Enumerable.Empty<PossibleMove>()
        };
        ...
        yield return new BlockedMoveForwardTestCase
        {
            SourcePiece = P.H6, BlockingPieces = new List<P> {P.G7},
            Moves = Enumerable.Empty<PossibleMove>()
        };
        ...
        yield return new BlockedMoveForwardTestCase
        {
            SourcePiece = P.B6, BlockingPieces = new List<P> {P.A7},
        ...
        yield return new BlockedMoveForwardTestCase
        {
            SourcePiece = P.B6, BlockingPieces = new List<P> {P.C7},
        ...
        yield return new BlockedMoveForwardTestCase
        {
            SourcePiece = P.D6, BlockingPieces = new List<P> {P.C7},
        ...
        yield return new BlockedMoveForwardTestCase
        {
            SourcePiece = P.D6, BlockingPieces = new List<P> {P.E7},
            Moves = new List<PossibleMove> {new(P.C7, new List<P> {P.C7}, 0)}
        };
        ...
        yield return new BlockedMoveForwardTestCase
        {
            SourcePiece = P.F6, BlockingPieces = new List<P> {P.E7},
        ...
        yield return new BlockedMoveForwardTestCase
        {
            SourcePiece = P.F6, BlockingPieces = new List<P> {P.G7},
            Moves = new List<PossibleMove> {new(P.E7, new List<P> {P.E7}, 0)}
        };
        ...
        yield return new BlockedMoveForwardTestCase
        {
            SourcePiece = P.A7, BlockingPieces = new List<P> {P.B8}, // A7 can only move to B8
            Moves = Enumerable.Empty<PossibleMove>()
        };
        ...
        yield return new BlockedMoveForwardTestCase
        {
            SourcePiece = P.C7, BlockingPieces = new List<P> {P.B8, P.D8},
            Moves = Enumerable.Empty<PossibleMove>()
        };
        ...
        yield return new BlockedMoveForwardTestCase
        {
            SourcePiece = P.E7, BlockingPieces = new List<P> {P.D8, P.F8},
            Moves = Enumerable.Empty<PossibleMove>()
        };
        ...
        yield return new BlockedMoveForwardTestCase
        {
            SourcePiece = P.G7, BlockingPieces = new List<P> {P.F8, P.H8},
            Moves = Enumerable.Empty<PossibleMove>()
        };
        ...
        yield return new BlockedMoveForwardTestCase
        {
            SourcePiece = P.C7, BlockingPieces = new List<P> {P.B8},
        ...
        yield return new BlockedMoveForwardTestCase
        {
            SourcePiece = P.C7, BlockingPieces = new List<P> {P.D8},
        ...
        yield return new BlockedMoveForwardTestCase
        {
            SourcePiece = P.E7, BlockingPieces = new List<P> {P.D8},
        ...
        yield return new BlockedMoveForwardTestCase
        {
            SourcePiece = P.E7, BlockingPieces = new List<P> {P.F8},
            Moves = new List<PossibleMove> {new(P.D8, new List<P> {P.D8}, 0)}
        };
        ...
        yield return new BlockedMoveForwardTestCase
        {
            SourcePiece = P.G7, BlockingPieces = new List<P> {P.F8},
        ...
        yield return new BlockedMoveForwardTestCase
        {
            SourcePiece = P.G7, BlockingPieces = new List<P> {P.H8},
            Moves = new List<PossibleMove> {new(P.F8, new List<P> {P.F8}, 0)}
        };
    }
}