...
public class BlackPieceMultipleCapturesWhitePiecesTestCases : IEnumerable
{
    public IEnumerator GetEnumerator()
    {
        yield return new TC {Source = P.H8, Captured = [P.G7, P.E5], Moves = [new M(P.D4, [P.G7, P.E5], 2)]};
