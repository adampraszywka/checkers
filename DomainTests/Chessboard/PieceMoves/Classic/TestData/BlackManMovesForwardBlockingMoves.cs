...
public class BlackManMovesForwardBlockingMoves : IEnumerable
{
    public IEnumerator GetEnumerator()
    {
        ...
        {
            SourcePiece = P.B8, BlockingPieces = new List<P> {P.A7, P.C7},
        ...
        yield return new BlockedMoveForwardTestCase
        {
            SourcePiece = P.D8, BlockingPieces = new List<P> {P.C7, P.E7},
            Moves = Enumerable.Empty<PossibleMove>()
        };
        ...
        yield return new BlockedMoveForwardTestCase
        {
            SourcePiece = P.F8, BlockingPieces = new List<P> {P.E7, P.G7},
            Moves = Enumerable.Empty<PossibleMove>()
        };
        ...
        yield return new BlockedMoveForwardTestCase
        {
            SourcePiece = P.H8, BlockingPieces = new List<P> {P.G7},
            Moves = Enumerable.Empty<PossibleMove>()
        };
        ...
        yield return new BlockedMoveForwardTestCase
        {
            SourcePiece = P.B8, BlockingPieces = new List<P> {P.A7},
        ...
        yield return new BlockedMoveForwardTestCase
        {
            SourcePiece = P.B8, BlockingPieces = new List<P> {P.C7},
        ...
        yield return new BlockedMoveForwardTestCase
        {
            SourcePiece = P.D8, BlockingPieces = new List<P> {P.C7},
        ...
        yield return new BlockedMoveForwardTestCase
        {
            SourcePiece = P.D8, BlockingPieces = new List<P> {P.E7},
            Moves = new List<PossibleMove> {new(P.C7, new List<P> {P.C7}, 0)}
        };
        ...
        yield return new BlockedMoveForwardTestCase
        {
            SourcePiece = P.F8, BlockingPieces = new List<P> {P.E7},
        ...
        yield return new BlockedMoveForwardTestCase
        {
            SourcePiece = P.F8, BlockingPieces = new List<P> {P.G7},
            Moves = new List<PossibleMove> {new(P.E7, new List<P> {P.E7}, 0)}
        };
        ...
        yield return new BlockedMoveForwardTestCase
        {
            SourcePiece = P.A7, BlockingPieces = new List<P> {P.B6}, // A7 can only move to B6
            Moves = Enumerable.Empty<PossibleMove>()
        };
        ...
        yield return new BlockedMoveForwardTestCase
        {
            SourcePiece = P.C7, BlockingPieces = new List<P> {P.B6, P.D6},
            Moves = Enumerable.Empty<PossibleMove>()
        };
        ...
        yield return new BlockedMoveForwardTestCase
        {
            SourcePiece = P.E7, BlockingPieces = new List<P> {P.D6, P.F6},
            Moves = Enumerable.Empty<PossibleMove>()
        };
        ...
        yield return new BlockedMoveForwardTestCase
        {
            SourcePiece = P.G7, BlockingPieces = new List<P> {P.F6, P.H6},
            Moves = Enumerable.Empty<PossibleMove>()
        };
        ...
        yield return new BlockedMoveForwardTestCase
        {
            SourcePiece = P.C7, BlockingPieces = new List<P> {P.B6},
        ...
        {
            SourcePiece = P.C7,
            BlockingPieces = new List<P> {P.D6},
        ...
        yield return new BlockedMoveForwardTestCase
        {
            SourcePiece = P.E7, BlockingPieces = new List<P> {P.D6},
        ...
        yield return new BlockedMoveForwardTestCase
        {
            SourcePiece = P.E7, BlockingPieces = new List<P> {P.F6},
            Moves = new List<PossibleMove> {new(P.D6, new List<P> {P.D6}, 0)}
        };
        ...
        yield return new BlockedMoveForwardTestCase
        {
            SourcePiece = P.G7, BlockingPieces = new List<P> {P.F6},
        ...
        yield return new BlockedMoveForwardTestCase
        {
            SourcePiece = P.G7, BlockingPieces = new List<P> {P.H6},
            Moves = new List<PossibleMove> {new(P.F6, new List<P> {P.F6}, 0)}
        };
        ...
        yield return new BlockedMoveForwardTestCase
        {
            SourcePiece = P.B6, BlockingPieces = new List<P> {P.A5, P.C5},
            Moves = Enumerable.Empty<PossibleMove>()
        };
        ...
        yield return new BlockedMoveForwardTestCase
        {
            SourcePiece = P.D6, BlockingPieces = new List<P> {P.C5, P.E5},
            Moves = Enumerable.Empty<PossibleMove>()
        };
        ...
        yield return new BlockedMoveForwardTestCase
        {
            SourcePiece = P.F6, BlockingPieces = new List<P> {P.E5, P.G5},
            Moves = Enumerable.Empty<PossibleMove>()
        };
        ...
        yield return new BlockedMoveForwardTestCase
        {
            SourcePiece = P.H6, BlockingPieces = new List<P> {P.G5}, // H6 can only move to G5
            Moves = Enumerable.Empty<PossibleMove>()
        };
        ...
        yield return new BlockedMoveForwardTestCase
        {
            SourcePiece = P.B6, BlockingPieces = new List<P> {P.A5},
        ...
        yield return new BlockedMoveForwardTestCase
        {
            SourcePiece = P.B6, BlockingPieces = new List<P> {P.C5},
        ...
        yield return new BlockedMoveForwardTestCase
        {
            SourcePiece = P.D6, BlockingPieces = new List<P> {P.C5},
        ...
        yield return new BlockedMoveForwardTestCase
        {
            SourcePiece = P.D6, BlockingPieces = new List<P> {P.E5},
            Moves = new List<PossibleMove> {new(P.C5, new List<P> {P.C5}, 0)}
        };
        ...
        yield return new BlockedMoveForwardTestCase
        {
            SourcePiece = P.F6, BlockingPieces = new List<P> {P.E5},
        ...
        yield return new BlockedMoveForwardTestCase
        {
            SourcePiece = P.F6, BlockingPieces = new List<P> {P.G5},
            Moves = new List<PossibleMove> {new(P.E5, new List<P> {P.E5}, 0)}
        };
        ...
        yield return new BlockedMoveForwardTestCase
        {
            SourcePiece = P.A5, BlockingPieces = new List<P> {P.B4},
            Moves = Enumerable.Empty<PossibleMove>()
        };
        ...
        yield return new BlockedMoveForwardTestCase
        {
            SourcePiece = P.C5, BlockingPieces = new List<P> {P.B4, P.D4},
            Moves = Enumerable.Empty<PossibleMove>()
        };
        ...
        yield return new BlockedMoveForwardTestCase
        {
            SourcePiece = P.E5, BlockingPieces = new List<P> {P.D4, P.F4},
            Moves = Enumerable.Empty<PossibleMove>()
        };
        ...
        yield return new BlockedMoveForwardTestCase
        {
            SourcePiece = P.G5, BlockingPieces = new List<P> {P.F4, P.H4},
            Moves = Enumerable.Empty<PossibleMove>()
        };
        ...
        yield return new BlockedMoveForwardTestCase
        {
            SourcePiece = P.C5, BlockingPieces = new List<P> {P.B4},
        ...
        yield return new BlockedMoveForwardTestCase
        {
            SourcePiece = P.C5, BlockingPieces = new List<P> {P.D4},
        ...
        yield return new BlockedMoveForwardTestCase
        {
            SourcePiece = P.E5, BlockingPieces = new List<P> {P.D4},
        ...
        yield return new BlockedMoveForwardTestCase
        {
            SourcePiece = P.E5, BlockingPieces = new List<P> {P.F4},
            Moves = new List<PossibleMove> {new(P.D4, new List<P> {P.D4}, 0)}
        };
        ...
        yield return new BlockedMoveForwardTestCase
        {
            SourcePiece = P.G5, BlockingPieces = new List<P> {P.F4},
        ...
        yield return new BlockedMoveForwardTestCase
        {
            SourcePiece = P.G5, BlockingPieces = new List<P> {P.H4},
            Moves = new List<PossibleMove> {new(P.F4, new List<P> {P.F4}, 0)}
        };
        ...
        yield return new BlockedMoveForwardTestCase
        {
            SourcePiece = P.B4, BlockingPieces = new List<P> {P.A3, P.C3},
            Moves = Enumerable.Empty<PossibleMove>()
        };
        ...
        yield return new BlockedMoveForwardTestCase
        {
            SourcePiece = P.D4, BlockingPieces = new List<P> {P.C3, P.E3},
            Moves = Enumerable.Empty<PossibleMove>()
        };
        ...
        yield return new BlockedMoveForwardTestCase
        {
            SourcePiece = P.F4, BlockingPieces = new List<P> {P.E3, P.G3},
            Moves = Enumerable.Empty<PossibleMove>()
        };
        ...
        yield return new BlockedMoveForwardTestCase
        {
            SourcePiece = P.H4, BlockingPieces = new List<P> {P.G3},
            Moves = Enumerable.Empty<PossibleMove>()
        };
        ...
        yield return new BlockedMoveForwardTestCase
        {
            SourcePiece = P.B4, BlockingPieces = new List<P> {P.A3},
        ...
        yield return new BlockedMoveForwardTestCase
        {
            SourcePiece = P.B4, BlockingPieces = new List<P> {P.C3},
        ...
        yield return new BlockedMoveForwardTestCase
        {
            SourcePiece = P.D4, BlockingPieces = new List<P> {P.C3},
        ...
        yield return new BlockedMoveForwardTestCase
        {
            SourcePiece = P.D4, BlockingPieces = new List<P> {P.E3},
            Moves = new List<PossibleMove> {new(P.C3, new List<P> {P.C3}, 0)}
        };
        ...
        yield return new BlockedMoveForwardTestCase
        {
            SourcePiece = P.F4, BlockingPieces = new List<P> {P.E3},
        ...
        yield return new BlockedMoveForwardTestCase
        {
            SourcePiece = P.F4, BlockingPieces = new List<P> {P.G3},
            Moves = new List<PossibleMove> {new(P.E3, new List<P> {P.E3}, 0)}
        };
        ...
        yield return new BlockedMoveForwardTestCase
        {
            SourcePiece = P.A3, BlockingPieces = new List<P> {P.B2},
            Moves = Enumerable.Empty<PossibleMove>()
        };
        ...
        yield return new BlockedMoveForwardTestCase
        {
            SourcePiece = P.C3, BlockingPieces = new List<P> {P.B2, P.D2},
            Moves = Enumerable.Empty<PossibleMove>()
        };
        ...
        yield return new BlockedMoveForwardTestCase
        {
            SourcePiece = P.E3, BlockingPieces = new List<P> {P.D2, P.F2},
            Moves = Enumerable.Empty<PossibleMove>()
        };
        ...
        yield return new BlockedMoveForwardTestCase
        {
            SourcePiece = P.G3, BlockingPieces = new List<P> {P.F2, P.H2},
            Moves = Enumerable.Empty<PossibleMove>()
        };
        ...
        yield return new BlockedMoveForwardTestCase
        {
            SourcePiece = P.C3, BlockingPieces = new List<P> {P.B2},
        ...
        yield return new BlockedMoveForwardTestCase
        {
            SourcePiece = P.C3, BlockingPieces = new List<P> {P.D2},
        ...
        yield return new BlockedMoveForwardTestCase
        {
            SourcePiece = P.E3, BlockingPieces = new List<P> {P.D2},
        ...
        yield return new BlockedMoveForwardTestCase
        {
            SourcePiece = P.E3, BlockingPieces = new List<P> {P.F2},
        ...
        yield return new BlockedMoveForwardTestCase
        {
            SourcePiece = P.G3, BlockingPieces = new List<P> {P.F2},
        ...
        yield return new BlockedMoveForwardTestCase
        {
            SourcePiece = P.G3, BlockingPieces = new List<P> {P.H2},
            Moves = new List<PossibleMove> {new(P.F2, new List<P> {P.F2}, 0)}
        };
        ...
        yield return new BlockedMoveForwardTestCase
        {
            SourcePiece = P.B2, BlockingPieces = new List<P> {P.A1, P.C1},
            Moves = Enumerable.Empty<PossibleMove>()
        };
        ...
        yield return new BlockedMoveForwardTestCase
        {
            SourcePiece = P.D2, BlockingPieces = new List<P> {P.C1, P.E1},
            Moves = Enumerable.Empty<PossibleMove>()
        };
        ...
        yield return new BlockedMoveForwardTestCase
        {
            SourcePiece = P.F2, BlockingPieces = new List<P> {P.E1, P.G1},
            Moves = Enumerable.Empty<PossibleMove>()
        };
        ...
        yield return new BlockedMoveForwardTestCase
        {
            SourcePiece = P.H2, BlockingPieces = new List<P> {P.G1}, // H2 can only move to G1
            Moves = Enumerable.Empty<PossibleMove>()
        };
        ...
        yield return new BlockedMoveForwardTestCase
        {
            SourcePiece = P.B2, BlockingPieces = new List<P> {P.A1},
            Moves = new List<PossibleMove>
            {
        ...
        yield return new BlockedMoveForwardTestCase
        {
            SourcePiece = P.B2, BlockingPieces = new List<P> {P.C1},
        ...
        yield return new BlockedMoveForwardTestCase
        {
            SourcePiece = P.D2, BlockingPieces = new List<P> {P.C1},
        ...
        yield return new BlockedMoveForwardTestCase
        {
            SourcePiece = P.D2, BlockingPieces = new List<P> {P.E1},
        ...
        yield return new BlockedMoveForwardTestCase
        {
            SourcePiece = P.F2, BlockingPieces = new List<P> {P.E1},
        ...
        yield return new BlockedMoveForwardTestCase
        {
            SourcePiece = P.F2, BlockingPieces = new List<P> {P.G1},
            Moves = new List<PossibleMove> {new(P.E1, new List<P> {P.E1}, 0)}
        };
    }
}