...
public class BlackPieceForwardCaptureBlockedByAnotherPiece : IEnumerable
{
    public IEnumerator GetEnumerator()
    {
        ...
        yield return new PieceForwardCaptureBlockTestCase
            {SourcePiece = P.B8, CapturedPieces = [P.A7, P.C7], BlockingPieces = [P.D6]};
        yield return new PieceForwardCaptureBlockTestCase
            {SourcePiece = P.D8, CapturedPieces = [P.C7, P.E7], BlockingPieces = [P.B6, P.F6]};
        yield return new PieceForwardCaptureBlockTestCase
            {SourcePiece = P.F8, CapturedPieces = [P.E7, P.G7], BlockingPieces = [P.D6, P.H6]};
        yield return new PieceForwardCaptureBlockTestCase
            {SourcePiece = P.H8, CapturedPieces = [P.G7], BlockingPieces = [P.F6]};
        ...
        yield return new PieceForwardCaptureBlockTestCase
            {SourcePiece = P.A3, CapturedPieces = [P.B2], BlockingPieces = [P.C1]};
        yield return new PieceForwardCaptureBlockTestCase
            {SourcePiece = P.C3, CapturedPieces = [P.B2, P.D2], BlockingPieces = [P.A1, P.E1]};
        yield return new PieceForwardCaptureBlockTestCase
            {SourcePiece = P.E3, CapturedPieces = [P.D2, P.F2], BlockingPieces = [P.C1, P.G1]};
        yield return new PieceForwardCaptureBlockTestCase
            {SourcePiece = P.G3, CapturedPieces = [P.F2, P.H2], BlockingPieces = [P.E1]};
    }
}