...
public class BlackPieceCapturesSingleWhitePieceTestCases : IEnumerable
{
    public IEnumerator GetEnumerator()
    {
        yield return new SinglePieceCaptureTestCase
        {
            SourcePiece = new P(P.R8, P.B),
            CapturedPieces = new[] {new P(P.R7, P.C), new P(P.R7, P.A)},
            Moves = new[] {new Move(new P(P.R6, P.D), new[] {new P(P.R7, P.C)}, 1)}
        };

        yield return new SinglePieceCaptureTestCase
        {
            SourcePiece = new P(P.R8, P.D),
            CapturedPieces = new[] {new P(P.R7, P.C)},
        ...
        {
            SourcePiece = new P(P.R8, P.D),
            CapturedPieces = new[] {new P(P.R7, P.E)},
            Moves = new[] {new Move(new P(P.R6, P.F), new[] {new P(P.R7, P.E)}, 1)}
        };

        yield return new SinglePieceCaptureTestCase
        {
            SourcePiece = new P(P.R8, P.F),
            CapturedPieces = new[] {new P(P.R7, P.E)},
        ...
        {
            SourcePiece = new P(P.R8, P.F),
            CapturedPieces = new[] {new P(P.R7, P.G)},
            Moves = new[] {new Move(new P(P.R6, P.H), new[] {new P(P.R7, P.G)}, 1)}
        };

        yield return new SinglePieceCaptureTestCase
        {
            SourcePiece = new P(P.R8, P.H),
            CapturedPieces = new[] {new P(P.R7, P.G)},
        ...
        {
            SourcePiece = new P(P.R8, P.D),
            CapturedPieces = new[] {new P(P.R7, P.C), new P(P.R7, P.E)},
            Moves = new[]
            {
        ...
        {
            SourcePiece = new P(P.R8, P.F),
            CapturedPieces = new[] {new P(P.R7, P.E), new P(P.R7, P.G)},
            Moves = new[]
            {
        ...
        yield return new SinglePieceCaptureTestCase
        {
            SourcePiece = new P(P.R7, P.A),
            CapturedPieces = new[] {new P(P.R6, P.B)},
        ...
        {
            SourcePiece = new P(P.R7, P.C),
            CapturedPieces = new[] {new P(P.R6, P.D)},
        ...
        {
            SourcePiece = new P(P.R7, P.E),
            CapturedPieces = new[] {new P(P.R6, P.F)},
        ...
        {
            SourcePiece = new P(P.R7, P.C),
            CapturedPieces = new[] {new P(P.R6, P.B), new P(P.R6, P.D)},
            Moves = new[]
            {
        ...
        {
            SourcePiece = new P(P.R7, P.E),
            CapturedPieces = new[] {new P(P.R6, P.D), new P(P.R6, P.F)},
            Moves = new[]
            {
        ...
        yield return new SinglePieceCaptureTestCase
        {
            SourcePiece = new P(P.R6, P.B),
            CapturedPieces = new[] {new P(P.R5, P.C)},
        ...
        {
            SourcePiece = new P(P.R6, P.D),
            CapturedPieces = new[] {new P(P.R5, P.E)},
        ...
        {
            SourcePiece = new P(P.R6, P.B),
            CapturedPieces = new[] {new P(P.R5, P.A), new P(P.R5, P.C)},
            Moves = new[]
            {
        ...
        {
            SourcePiece = new P(P.R6, P.D),
            CapturedPieces = new[] {new P(P.R5, P.C), new P(P.R5, P.E)},
            Moves = new[]
            {
        ...
        yield return new SinglePieceCaptureTestCase
        {
            SourcePiece = new P(P.R5, P.C),
            CapturedPieces = new[] {new P(P.R4, P.B)},
        ...
        {
            SourcePiece = new P(P.R5, P.C),
            CapturedPieces = new[] {new P(P.R4, P.D)},
        ...
        {
            SourcePiece = new P(P.R5, P.E),
            CapturedPieces = new[] {new P(P.R4, P.F)},
        ...
        {
            SourcePiece = new P(P.R5, P.C),
            CapturedPieces = new[] {new P(P.R4, P.B), new P(P.R4, P.D)},
            Moves = new[]
            {
        ...
        {
            SourcePiece = new P(P.R5, P.E),
            CapturedPieces = new[] {new P(P.R4, P.D), new P(P.R4, P.F)},
            Moves = new[]
            {
        ...
        yield return new SinglePieceCaptureTestCase
        {
            SourcePiece = new P(P.R4, P.B),
            CapturedPieces = new[] {new P(P.R3, P.C), new P(P.R3, P.A)},
        ...
        yield return new SinglePieceCaptureTestCase
        {
            SourcePiece = new P(P.R4, P.D),
            CapturedPieces = new[] {new P(P.R3, P.C)},
        ...
        {
            SourcePiece = new P(P.R4, P.D),
            CapturedPieces = new[] {new P(P.R3, P.E)},
        ...
        {
            SourcePiece = new P(P.R4, P.B),
            CapturedPieces = new[] {new P(P.R3, P.A), new P(P.R3, P.C)},
            Moves = new[]
            {
        ...
        {
            SourcePiece = new P(P.R4, P.D),
            CapturedPieces = new[] {new P(P.R3, P.C), new P(P.R3, P.E)},
            Moves = new[]
            {
        ...
        yield return new SinglePieceCaptureTestCase
        {
            SourcePiece = new P(P.R3, P.C),
            CapturedPieces = new[] {new P(P.R2, P.B)},
        ...
        {
            SourcePiece = new P(P.R3, P.C),
            CapturedPieces = new[] {new P(P.R2, P.D)},
        ...
        {
            SourcePiece = new P(P.R3, P.E),
            CapturedPieces = new[] {new P(P.R2, P.F)},
        ...
        {
            SourcePiece = new P(P.R3, P.C),
            CapturedPieces = new[] {new P(P.R2, P.B), new P(P.R2, P.D)},
            Moves = new[]
            {
        ...
        {
            SourcePiece = new P(P.R3, P.E),
            CapturedPieces = new[] {new P(P.R2, P.D), new P(P.R2, P.F)},
            Moves = new[]
            {
