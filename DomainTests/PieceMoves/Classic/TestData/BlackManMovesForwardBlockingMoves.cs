...
public class BlackManMovesForwardBlockingMoves : IEnumerable
{
    public IEnumerator GetEnumerator()
    {
        ...
        yield return new BlockedMoveForwardTestCase
        {
            ...
            Moves = new List<Move> {new (P.A1, new List<Position> {P.A1}, 0)}
        };
        ...
        yield return new BlockedMoveForwardTestCase
        {
            ...
            Moves = new List<Move> {new (P.E1, new List<Position> {P.E1}, 0)}
        };
        ...
        yield return new BlockedMoveForwardTestCase
        {
            ...
            Moves = new List<Move>{new (P.C1, new List<Position> {P.C1}, 0)}
        };
        ...
        yield return new BlockedMoveForwardTestCase
        {
            ...
            Moves = new List<Move> {new (P.G1, new List<Position> {P.G1}, 0)}
        };
