...
public class WhiteManMovesForward : IEnumerable<MoveForwardTestCase>
{
    public IEnumerator<MoveForwardTestCase> GetEnumerator()
    {
        ...
        //Row8
        yield return new MoveForwardTestCase { Source = new P(P.R8, P.B), Moves = new List<Move>() };
        yield return new MoveForwardTestCase { Source = new P(P.R8, P.D), Moves = new List<Move>() };
