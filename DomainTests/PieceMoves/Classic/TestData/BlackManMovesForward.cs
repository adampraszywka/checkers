...
public class BlackManMovesForward : IEnumerable<TestCase>
{
    public IEnumerator<TestCase> GetEnumerator()
    {
        ...
        // Row 1
        yield return new TestCase { Source = new P(P.R1, P.A), Moves = new List<Move>() }; // No moves since it's at the edge
        yield return new TestCase { Source = new P(P.R1, P.C), Moves = new List<Move>() }; // No moves
        yield return new TestCase { Source = new P(P.R1, P.E), Moves = new List<Move>() }; // No moves
        yield return new TestCase { Source = new P(P.R1, P.G), Moves = new List<Move>() }; // No moves;
    }
