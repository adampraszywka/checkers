...
public class WhiteManMovesForwardBlockingMoves : IEnumerable
{
    public IEnumerator GetEnumerator()
    {
        ...
        yield return new BlockedMoveForwardTestCase
        {
            ...
            Moves = new List<PossibleMove> {new (P.D8, new List<Position> {P.D8}, 0)}
        };
        ...
        yield return new BlockedMoveForwardTestCase
        {
            ...
            Moves = new List<PossibleMove> {new (P.B8, new List<Position> {P.B8}, 0)}
        };
        ...
        yield return new BlockedMoveForwardTestCase
        {
            ...
            Moves = new List<PossibleMove> {new (P.F8, new List<Position> {P.F8}, 0)}
        };
        ...
        yield return new BlockedMoveForwardTestCase
        {
            ...
            Moves = new List<PossibleMove> {new (P.H8, new List<Position> {P.H8}, 0)}
        };
