...
public class KingMoves(Color playerColor, Color opponentColor)
{
...

        {
            ...
            while (positionRightForward.IsWithinBoard(boardSnapshot.BoardSize))
            {
                ...
                if (positionRightForward.IsWithinBoard(boardSnapshot.BoardSize))
                {
                    ...
                    if (piece is not null && piece.Color == opponentColor)
                    {
                    ...
                    if (piece is not null && piece.Color == playerColor)
                    {
                        break;
                    }
